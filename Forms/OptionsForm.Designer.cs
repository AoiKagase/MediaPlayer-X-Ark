...
namespace MediaPlayer_X_Ark
{
    partial class OptionsForm
    {
		...
		private void InitializeComponent()
		{
			...
			System.Windows.Forms.TreeNode treeNode15 = new System.Windows.Forms.TreeNode("その他", new System.Windows.Forms.TreeNode[] { treeNode14 });
			...
			lblDspBufferCountUnit = new System.Windows.Forms.Label();
			lblDspBufferSizeUnit = new System.Windows.Forms.Label();
			lblStreamBufferUnit = new System.Windows.Forms.Label();
			lblBufferNote = new System.Windows.Forms.Label();
			lblDspBufferCount = new System.Windows.Forms.Label();
			lblDspBufferSize = new System.Windows.Forms.Label();
			lblStreamBuffer = new System.Windows.Forms.Label();
			...
			nudDspBufferCount = new System.Windows.Forms.NumericUpDown();
			nudDspBufferSize = new System.Windows.Forms.NumericUpDown();
			nudStreamBuffer = new System.Windows.Forms.NumericUpDown();
			...
			((System.ComponentModel.ISupportInitialize)nudDspBufferCount).BeginInit();
			((System.ComponentModel.ISupportInitialize)nudDspBufferSize).BeginInit();
			((System.ComponentModel.ISupportInitialize)nudStreamBuffer).BeginInit();
			...
			treeNode15.Text = "その他";
			TreeMenu.Nodes.AddRange(new System.Windows.Forms.TreeNode[] { treeNode1, treeNode12, treeNode13, treeNode15 });
			...
			tabSetting.Controls.Add(lblDspBufferCountUnit);
			tabSetting.Controls.Add(lblDspBufferSizeUnit);
			tabSetting.Controls.Add(lblStreamBufferUnit);
			tabSetting.Controls.Add(lblBufferNote);
			tabSetting.Controls.Add(lblDspBufferCount);
			tabSetting.Controls.Add(lblDspBufferSize);
			tabSetting.Controls.Add(lblStreamBuffer);
			...
			tabSetting.Controls.Add(nudDspBufferCount);
			tabSetting.Controls.Add(nudDspBufferSize);
			tabSetting.Controls.Add(nudStreamBuffer);
			...
			// 
			// lblDspBufferCountUnit
			// 
			lblDspBufferCountUnit.FlatStyle = System.Windows.Forms.FlatStyle.System;
			lblDspBufferCountUnit.Location = new System.Drawing.Point(246, 142);
			lblDspBufferCountUnit.Name = "lblDspBufferCountUnit";
			lblDspBufferCountUnit.Size = new System.Drawing.Size(20, 15);
			lblDspBufferCountUnit.TabIndex = 36;
			lblDspBufferCountUnit.Text = "個";
			lblDspBufferCountUnit.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// lblDspBufferSizeUnit
			// 
			lblDspBufferSizeUnit.Location = new System.Drawing.Point(246, 112);
			lblDspBufferSizeUnit.Name = "lblDspBufferSizeUnit";
			lblDspBufferSizeUnit.Size = new System.Drawing.Size(50, 15);
			lblDspBufferSizeUnit.TabIndex = 35;
			lblDspBufferSizeUnit.Text = "サンプル";
			lblDspBufferSizeUnit.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// lblStreamBufferUnit
			// 
			lblStreamBufferUnit.FlatStyle = System.Windows.Forms.FlatStyle.System;
			lblStreamBufferUnit.Location = new System.Drawing.Point(246, 82);
			lblStreamBufferUnit.Name = "lblStreamBufferUnit";
			lblStreamBufferUnit.Size = new System.Drawing.Size(40, 15);
			lblStreamBufferUnit.TabIndex = 34;
			lblStreamBufferUnit.Text = "KB";
			lblStreamBufferUnit.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// lblBufferNote
			// 
			lblBufferNote.FlatStyle = System.Windows.Forms.FlatStyle.System;
			lblBufferNote.ForeColor = System.Drawing.Color.Gray;
			lblBufferNote.Location = new System.Drawing.Point(10, 170);
			lblBufferNote.Name = "lblBufferNote";
			lblBufferNote.Size = new System.Drawing.Size(220, 15);
			lblBufferNote.TabIndex = 33;
			lblBufferNote.Text = "※ 次回起動時に反映";
			lblBufferNote.TextAlign = System.Drawing.ContentAlignment.MiddleLeft;
			// 
			// lblDspBufferCount
			// 
			lblDspBufferCount.FlatStyle = System.Windows.Forms.FlatStyle.System;
			lblDspBufferCount.Location = new System.Drawing.Point(10, 140);
			lblDspBufferCount.Name = "lblDspBufferCount";
			lblDspBufferCount.Size = new System.Drawing.Size(130, 15);
			lblDspBufferCount.TabIndex = 32;
			lblDspBufferCount.Text = "DSPバッファ数";
			lblDspBufferCount.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// lblDspBufferSize
			// 
			lblDspBufferSize.Location = new System.Drawing.Point(10, 110);
			lblDspBufferSize.Name = "lblDspBufferSize";
			lblDspBufferSize.Size = new System.Drawing.Size(130, 15);
			lblDspBufferSize.TabIndex = 31;
			lblDspBufferSize.Text = "DSPバッファサイズ";
			lblDspBufferSize.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// lblStreamBuffer
			// 
			lblStreamBuffer.Location = new System.Drawing.Point(10, 80);
			lblStreamBuffer.Name = "lblStreamBuffer";
			lblStreamBuffer.Size = new System.Drawing.Size(130, 15);
			lblStreamBuffer.TabIndex = 30;
			lblStreamBuffer.Text = "ストリームバッファ";
			lblStreamBuffer.TextAlign = System.Drawing.ContentAlignment.MiddleRight;
			// 
			// lblOutputNote
			// 
			...
			// nudDspBufferCount
			// 
			nudDspBufferCount.Location = new System.Drawing.Point(160, 138);
			nudDspBufferCount.Maximum = new decimal(new int[] { 8, 0, 0, 0 });
			nudDspBufferCount.Minimum = new decimal(new int[] { 2, 0, 0, 0 });
			nudDspBufferCount.Name = "nudDspBufferCount";
			nudDspBufferCount.Size = new System.Drawing.Size(80, 23);
			nudDspBufferCount.TabIndex = 27;
			nudDspBufferCount.Value = new decimal(new int[] { 4, 0, 0, 0 });
			// 
			// nudDspBufferSize
			// 
			nudDspBufferSize.Increment = new decimal(new int[] { 512, 0, 0, 0 });
			nudDspBufferSize.Location = new System.Drawing.Point(160, 108);
			nudDspBufferSize.Maximum = new decimal(new int[] { 4096, 0, 0, 0 });
			nudDspBufferSize.Minimum = new decimal(new int[] { 512, 0, 0, 0 });
			nudDspBufferSize.Name = "nudDspBufferSize";
			nudDspBufferSize.Size = new System.Drawing.Size(80, 23);
			nudDspBufferSize.TabIndex = 28;
			nudDspBufferSize.Value = new decimal(new int[] { 2048, 0, 0, 0 });
			// 
			// nudStreamBuffer
			// 
			nudStreamBuffer.Location = new System.Drawing.Point(160, 78);
			nudStreamBuffer.Maximum = new decimal(new int[] { 512, 0, 0, 0 });
			nudStreamBuffer.Minimum = new decimal(new int[] { 16, 0, 0, 0 });
			nudStreamBuffer.Name = "nudStreamBuffer";
			nudStreamBuffer.Size = new System.Drawing.Size(80, 23);
			nudStreamBuffer.TabIndex = 29;
			nudStreamBuffer.Value = new decimal(new int[] { 128, 0, 0, 0 });
			// 
			// tabGEqualizer
			// 
			...
			((System.ComponentModel.ISupportInitialize)nudDspBufferCount).EndInit();
			((System.ComponentModel.ISupportInitialize)nudDspBufferSize).EndInit();
			((System.ComponentModel.ISupportInitialize)nudStreamBuffer).EndInit();
		...
		private System.Windows.Forms.NumericUpDown nudStreamBuffer;
		private System.Windows.Forms.NumericUpDown nudDspBufferSize;
		private System.Windows.Forms.NumericUpDown nudDspBufferCount;
		private System.Windows.Forms.Label lblBufferNote;
		private System.Windows.Forms.Label lblDspBufferCount;
		private System.Windows.Forms.Label lblDspBufferSize;
		private System.Windows.Forms.Label lblStreamBuffer;
		private System.Windows.Forms.Label lblDspBufferCountUnit;
		private System.Windows.Forms.Label lblDspBufferSizeUnit;
		private System.Windows.Forms.Label lblStreamBufferUnit;
	}
}